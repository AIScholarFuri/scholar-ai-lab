...
const HeroSection: React.FC = () => {
  return (
    <section className="min-h-screen relative flex items-center pt-16" id="hero">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-10 max-w-2xl animate-fade-in" style={{ animationDelay: '0.2s' }}>
